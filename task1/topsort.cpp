...
int main(int argc, char *argv[]) {
    p("los gehts");
    // Fenster der Gr��e 800 x 600 zur Graphendarstellung erzeugen
    GraphWin gw(800, 600);
    ...
    // in dieser Variable merken wir uns die n�chste zu vergebende Nummer
    int akt = g.number_of_nodes();

    do {
        // jetzt lassen wir den Benutzer mit der Maus einen unbesuchten Knoten
        // ausw�hlen (wenn er danebenklickt, wird NULL zur�ckgeliefert),
    ...
    gw.acknowledge("Ready!"); // Dialogbox anzeigen und best�tigen lassen
